...
var require_proxy = /* @__PURE__ */ require_core.__commonJSMin(((exports) => {
...
var require_lib = /* @__PURE__ */ require_core.__commonJSMin(((exports) => {
	...
	const tunnel = __importStar(require_core.require_tunnel());
	const undici_1 = require_core.require_undici();
	var HttpCodes;
	(function(HttpCodes) {
...
var import_lib = /* @__PURE__ */ require_core.__toESM(require_lib(), 1);
var import_undici = require_core.require_undici();
...
var require_fast_content_type_parse = /* @__PURE__ */ require_core.__commonJSMin(((exports, module) => {
...
async function run() {
	...
	let version = require_core.getInput("version");
	const preid = require_core.getInput("preid") || "dev";
	const preidDelimiter = require_core.getInput("preid-num-delimiter") || ".";
	const preidBranchesInput = require_core.getInput("preid-branches");
	const isForcePreid = require_core.getBooleanInput("force-preid");
	const isForceStable = require_core.getBooleanInput("force-stable");
	...
	require_core.info(`isForcePreid: ${isForcePreid}, Branch: ${branch}, ContextRef: ${context.ref}, Version: ${version}, RunNumber: ${runNumber}, PreidBranches: ${preidBranches}`);
	let versionSuffix;
	...
	if (isPreRel) {
		require_core.debug("Use preid for branch");
	...
	require_core.notice(`Version: ${buildVersion}, nonSemverVersion: ${nonSemverVersion}`);
	require_core.setOutput("version", buildVersion);
	require_core.setOutput("nonSemverVersion", nonSemverVersion);
	require_core.setOutput("majorVersion", major);
	require_core.setOutput("minorVersion", minor);
	require_core.setOutput("patchVersion", patch);
	require_core.setOutput("preid", preidOutput);
	require_core.setOutput("isPrerelease", isPreRel);
}
